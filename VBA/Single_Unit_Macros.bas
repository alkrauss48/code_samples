...
'checks row length of all four columns to see which is longest

Dim i, LastRow, LastRow1, LastRow2, LastRow3, LastRow4, LastRow5, LastRow6
...
'Check to see which row is the real last row
    
LastRow = WorksheetFunction.Max(LastRow1, LastRow2, LastRow3, LastRow4, LastRow5, LastRow6)

'adds the unit name in column A for the entire column
...
Dim i, LastRow, LastRow1, LastRow2, LastRow3, LastRow4, LastRow5
LastRow1 = Range("B" & Rows.Count).End(xlUp).Row
LastRow2 = Range("C" & Rows.Count).End(xlUp).Row
LastRow3 = Range("D" & Rows.Count).End(xlUp).Row
LastRow4 = Range("E" & Rows.Count).End(xlUp).Row
...
'inserts unit name for the entire column A
Range("A1").Value = current.Range("A1")
Range("A1").Select
Selection.AutoFill Destination:=Range("A1:A" & LastRow), Type:=xlFillDefault
...
Do While y <= endingRowSUSP And SUSPcount <> 0          'sums all interests for SUSP owners, unless there aren't any                           'sums all interests for SUSP owners
